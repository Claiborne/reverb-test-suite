...
describe "Article ingestion - duplicate doc", :duplicate => true do
  ...
  context 'submit near duplicate document' do
  ...
  context 'submit duplicate-at-beginning document' do
  ...
  context 'submit duplicate-but-shorter document' do
  ...
  context 'submit exact duplicate document' do
