...
path_to_urls = File.dirname(__FILE__)+"/../../lib/odin/shortened_urls.txt"
shortened_urls =  []

File.open(path_to_urls, "r") do |f|
  f.each_line do |line|
    shortened_urls << line.strip
  end
end
...
describe "Article ingestion - shortened urls", :shortened_urls => true do
