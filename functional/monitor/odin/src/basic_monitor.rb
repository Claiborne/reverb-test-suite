...
MIN_TOTAL_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME
MAX_TOTAL_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME

MIN_COMPLETED_CLOSED_COUNT_THRESHOLD = IGNORE*TIME_FRAME
MAX_COMPLETED_CLOSED_COUNT_THRESHOLD = IGNORE*TIME_FRAME

MIN_FAILED_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME
MAX_FAILED_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME

MIN_CANCELED_CLOSED_COUNT_THRESHOLD = IGNORE*TIME_FRAME
MAX_CANCELED_CLOSED_COUNT_THRESHOLD = IGNORE*TIME_FRAME

MIN_TERMINATED_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME
MAX_TERMINATED_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME

MIN_CONT_AS_NEW_CLOSED_COUNT_THRESHOLD = IGNORE*TIME_FRAME
MAX_CONT_AS_NEW_CLOSED_COUNT_THRESHOLD = IGNORE*TIME_FRAME

MIN_TIMEOUT_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME
MAX_TIMEOUT_CLOSED_COUNT_THRESHOLD = 1*TIME_FRAME

MIN_CURRENT_OPEN_WORKFLOWS_COUNT_THRESHOLD = 1
MAX_CURRENT_OPEN_WORKFLOWS_COUNT_THRESHOLD = 1
